...
public:
	...
	virtual void sleep() const = 0; // pure virtual function
	            // this makes the class an Abstract Data Type
	virtual void eat() const = 0;
	virtual void reproduce() const = 0;
	virtual void move() const = 0;
	virtual void speak() const = 0;
private:
	int age; // private: will be accessible only with Mammal's original methods
};
